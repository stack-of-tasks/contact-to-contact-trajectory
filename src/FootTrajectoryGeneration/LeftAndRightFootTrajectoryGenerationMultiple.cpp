...
LeftAndRightFootTrajectoryGenerationMultiple(FootSpecifications * lFoot) 
{
  m_Omega = 0.0;
  m_Foot = lFoot;

  m_LeftFootTrajectory = new FootTrajectoryGenerationMultiple(m_Foot);
  m_RightFootTrajectory = new FootTrajectoryGenerationMultiple(m_Foot);

}

 FootSpecifications* LeftAndRightFootTrajectoryGenerationMultiple::getFoot() const
{
  return m_Foot;
}
LeftAndRightFootTrajectoryGenerationMultiple::
...
{
  LeftAndRightFootTrajectoryGenerationMultiple (aLRFTGM.getFoot());
  *this = aLRFTGM;
}
			    ...
			    bool IgnoreFirst, bool Continuity)
{
  ...
  MatrixXd MM(2,2);
  MatrixXd CurrentSupportFootPosition(3,3);
  CurrentSupportFootPosition.setIdentity();
  MatrixXd Orientation(2,2);
