...
OnLineFootTrajectoryGeneration::OnLineFootTrajectoryGeneration(FootSpecifications *aFoot)
: FootTrajectoryGenerationStandard(aFoot)
{
    ...
    deque<FootAbsolutePosition> & FinalRightFootTraj_deq)
{
  ...
  int StepType = 1;
  unsigned int CurrentIndex = (int)FinalLeftFootTraj_deq.size()-1;
