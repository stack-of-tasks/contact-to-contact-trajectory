...
namespace PatternGeneratorJRL
{
  ...
  class  LeftAndRightFootTrajectoryGenerationMultiple
	...
	and not every sampled control time).
      ...
      /*! Returns foot */
      FootSpecifications * getFoot() const;
